...
# 收集静态文件
log_info "收集静态文件..."
python manage.py collectstatic --noinput 2>/dev/null || log_warning "静态文件收集跳过"
...
echo ""
log_success "==================== 生产服务器启动 ===================="
log_success "服务地址: http://$LOCAL_IP:$PORT"
log_success "工作进程: $WORKERS"
log_success "======================================================="
echo ""
